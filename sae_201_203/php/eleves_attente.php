...
$stmt = $pdo->query("SELECT * FROM inscription WHERE statut = 'attente' AND role_personne = 'Etudiant'");
            ...
            <tbody>
                <?php foreach ($etudiants as $etudiant): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($etudiant['role_personne']) ?></td>
                        <td><?= htmlspecialchars($etudiant['num']) ?></td>

...
// Permet d'éviter les erreurs "variable non définie" lors de l'affichage du formulaire
// $succes affichera un message de succès après l'ajout
// $erreur affichera un message d'erreur si l'insertion échoue
$succes = null;
$erreur = null;
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    try {
        ...
        $succes = "✅ La personne a bien été ajoutée à la base de données.";
...
<head>
    ...
    <title>Ajout d'une personne - Admin</title>
</head>
<body>
            ...
            <div class="card shadow w-100" style="max-width: 500px;">
                <div class="card-header py-3" style="background-color: #BBEFF4; border-bottom: none; padding-bottom: 0.75rem;">
                    <div class="d-flex align-items-center">
                        ...
                        <span class="fw-bold fs-5" style="color: #222;">Ajout d'une personne (admin)</span>
                    </div>
                </div>
                <div class="card-body p-4">
                    <?php if ($succes) echo "<p class='text-success'>$succes</p>"; ?>
                    <?php if ($erreur) echo "<p class='text-danger'>$erreur</p>"; ?>
                    <form action="" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="groupe" class="form-label">Groupe (Si vous êtes étudiant)</label>
                            <select class="form-select" id="groupe" name="groupe">
                                <option value="">Sélectionnez un groupe</option>
                                <option value="MMI 1 - TD1">MMI 1 - TD1</option>
                                <option value="MMI 1 - TD2">MMI 1 - TD2</option>
                                <option value="MMI 1 - TD3">MMI 1 - TD3</option>
                                <option value="MMI 2 - TD1">MMI 2 - TD1</option>
                                <option value="MMI 2 - TD2">MMI 2 - TD2</option>
                                <option value="MMI 2 - TD3">MMI 2 - TD3</option>
                                <option value="MMI 3 - TD1">MMI 3 - TD1</option>
                                <option value="MMI 3 - TD2">MMI 3 - TD2</option>
                                <option value="MMI 3 - TD3">MMI 3 - TD3</option>
                            </select>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="d-grid mb-3">
                            <button type="submit" class="btn btn-primary btn-lg text-white">Ajouter</button>
                        </div>

                        <div class="text-center mt-4">
                            <a href="afficher_tout.php" class="btn btn-secondary">Retour à la liste</a>
                        </div>
                    </form>
                </div>
            </div>

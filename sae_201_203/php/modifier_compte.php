...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Rediriger selon le rôle APRÈS la modification
    if ($role_personne === 'Agent' || $role_personne === 'Administrateur') {
...
<body>
    <form class="form-modif" method="POST">
        ...
        <?php
        if ($personne['role_personne'] === 'Administrateur') {
            echo '<a href="compte_admin.php">Retour</a>';
        } elseif ($personne['role_personne'] === 'Agent') {
            echo '<a href="compte_admin.php">Retour</a>';
        } elseif ($personne['role_personne'] === 'Enseignant') {
            echo '<a href="compte.php">Retour</a>';
        } elseif ($personne['role_personne'] === 'Etudiant') {
            echo '<a href="compte.php">Retour</a>';
        } else {
            echo '<a href="compte.php">Retour</a>';
        }

...
<head>
    ...
    <link rel="stylesheet" href="../css/style_compte_admin.css">
        ...
        <?php if (count($reservations_materiel) > 0): ?>
            <div class="liste-reservations">
                <?php foreach ($reservations_materiel as $res_mat): ?>
                    <div class="reservation-card">
                        <p><strong>ID du matériel :</strong> <?= htmlspecialchars($res_mat['id_materiel']) ?></p>
                        <p><strong>Type de matériel :</strong> <?= htmlspecialchars($res_mat['type_materiel']) ?></p>

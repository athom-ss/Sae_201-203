...
<body>
        ...
        <div class="compte-wrapper">
            ...
            <div class="fiche-details">
                <div class="detail-row">
                    ...
                    <!-- strong sert à mettre le texte en gras et montre qu'il a de l'importance -->
                    <!-- span sert à cibler une partie de texte -->
                </div>
                <div class="detail-row">
    ...
    <div class="reservation-list">
        ...
        <div class="reservation-item">
            <div class="reservation-image">Image</div>
            <div class="reservation-info">
                <p><strong>Nom :</strong> Caméra Sony</p>
                <p><strong>Début :</strong> 01/05/2025 à 8h</p>
                <p><strong>Fin :</strong> 01/05/2025 à 18h</p>
            </div>
            <button class="btn-supprimer">Supprimer</button>
        </div>

        <!-- D'autres .reservation-item ici -->
    </div>
</div>    
</div>
</body>
